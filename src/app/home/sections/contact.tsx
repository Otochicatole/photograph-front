            ...
            >
                {!isSubmitted ? (
                    ...
                    <div className="flex flex-col items-center justify-center w-full relative overflow-hidden">
                        ...
                        >
                            <div
                                className='flex flex-col items-center justify-center h-[70vh] w-full lg:w-[80%] shadow-xl gap-6  rounded-sm p-3'>
                                <h2 className='text-7xl text-black/30'>GRAZIE</h2>
                                <p className='text-black/30 text-3xl'>La sua richiesta è stata inviata, <br/> pronto mi
                                    contatterò con lei 💖</p>
                                <Button variant="secondary" className="w-[275px] mt-10" onClick={() => {
                                    router.push('/')
